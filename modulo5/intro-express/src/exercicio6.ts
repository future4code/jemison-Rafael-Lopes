...
// Resposta: Para melhor organização do conteúdo dentro do array e visibilidade do código chego a conclusão 
// que é melhor criar o array de posts fora do array de usuários
