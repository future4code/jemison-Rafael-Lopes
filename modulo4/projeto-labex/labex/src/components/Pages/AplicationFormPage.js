  ...
  return (
    <div>
      ...
      <form onSubmit={enviarFormulario}>
        ...
        <select required>
          <option value='Choose'>Escolha a sua viagem</option>
          ...
          <option value='Gisele581c'>Gisele581c</option>
        </select>
        <br />
        ...
        />
        <br />
        <label htmlFor={"textAreaApplication"}>Escreva abaixo os motivos que demonstrem porque você é o melhor candidato para essa viagem:</label>
        <p><textarea
          type="text"
          id="descricao"
          name="description"
          value={textAreaApplication}
          onChange={onChangeTextApplication}
        ...
        <select required>
          <option value='Choose'>Escolha o seu País de origem</option>
